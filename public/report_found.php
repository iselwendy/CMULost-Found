...
// ── Prefill from gallery "I Found This Item" link ─────────────────────────
...
<body class="bg-slate-50 min-h-screen text-slate-900">
    ...
    <main class="max-w-2xl mx-auto px-4 py-8">
        ...
        <!-- Context banner when arriving from a "I Found This Item" click -->
        <div class="mb-6 flex items-start gap-4 bg-green-50 border border-green-200 rounded-2xl p-5">
            <div class="w-10 h-10 bg-green-500 text-white rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm">
                <i class="fas fa-hand-holding-heart"></i>
            </div>
            <div>
                <p class="text-sm font-black text-green-900">Reporting a found item matching a lost report</p>
                <p class="text-xs text-green-700 mt-1 leading-relaxed">
                    We've pre-filled the public details from the lost report for
                    <strong>"<?php echo htmlspecialchars($pre_title); ?>"</strong>.
                    Please complete the <strong>Guardian Protocol</strong> section with what you actually observed —
                    this helps OSA verify ownership when the owner comes to claim it.
                </p>
                <a href="index.php?view=lost" class="inline-flex items-center gap-1 text-[11px] font-bold text-green-700 hover:text-green-900 mt-2 underline">
        ...
        <div class="glass-card rounded-2xl shadow-xl p-6 md:p-8">
            <header class="mb-8">
                ...
                <h1 class="text-2xl font-bold text-slate-800">
                    <?php echo $prefill ? 'Report Found Item (Linked to Lost Report)' : 'Report a Found Item'; ?>
                </h1>
                <p class="text-slate-500 mt-1">
                    <?php echo $prefill
                        ? 'Confirm the details and describe what you observed so the owner can be verified.'
                        : 'Thank you for being a responsible CMU student! Your report helps return items to their rightful owners.'; ?>
                </p>
            </header>
            ...
            <form id="foundItemForm" action="process_report.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <?php if ($pre_lost_id): ?>
                <input type="hidden" name="linked_lost_id" value="<?php echo $pre_lost_id; ?>">
                <?php endif; ?>
                ...
                <div class="pt-6">
                    <button type="submit"
                        ...
                        <?php echo $prefill ? 'Submit Found Report' : 'Register Found Item'; ?>
                    </button>
                </div>
            </form>
        </div>
