            ...
            <form action="../core/process_report.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <section class="space-y-4 pt-4">
                    <div class="flex items-center gap-2 border-b pb-2">
                        ...
                        <span class="text-[10px] bg-indigo-600 text-white px-2 py-0.5 rounded-full font-bold">PRIVATE</span>
                    </div>
                ...
                <div class="pt-6">
                    <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-indigo-200 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2">
